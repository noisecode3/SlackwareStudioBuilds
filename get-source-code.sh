...
wget https://mirrors.edge.kernel.org/pub/linux/kernel/projects/rt/5.17/patch-5.17-rc8-rt14.patch.xz
wget https://git.kernel.org/torvalds/t/linux-5.17-rc8.tar.gz
